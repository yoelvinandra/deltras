...
<section class="squad-section">
  ...
  <div class="squad-header-mobile">
    ...
    <br>
    <span class="squad-detail fira-sans-regular">Official profiles of Deltras FC players listed in the club’s.</span>
  </div>
...
<section class="highlight-section">
 <!-- LEFT COLUMN -->
  ...
  <div class="left-col">
    <div class="highlight-section-primary">
      <!-- HIGHLIGHT SECTION -->
              ...
              <div class="prev-item">
                  ...
                  <div class="prev-info-detail">
                    <div class="prev-team-1">
                      ...
                      <img src="`+data.rows.RESULT[x].GAMBARCLUB1+`">
                    </div> 
                    ...
                    <div class="prev-team-2">
                      <img src="`+data.rows.RESULT[x].GAMBARCLUB2+`">
